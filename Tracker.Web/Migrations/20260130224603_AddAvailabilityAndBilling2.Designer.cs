...
namespace Tracker.Web.Migrations
{
    ...
    [Migration("20260130224603_AddAvailabilityAndBilling2")]
    partial class AddAvailabilityAndBilling2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Availability.CompanyHoliday", b =>
                {
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Availability.ResourceAvailability", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Availability.ResourceSchedule", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Billing.ClientRate", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ResourceId", "ClientId");

                    b.ToTable("ClientRates");
                });

            modelBuilder.Entity("Tracker.Web.Entities.Billing.ResourceRate", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Billing.ServiceAreaRate", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ServiceAreaId", "ResourceTypeId");

                    b.ToTable("ServiceAreaRates");
                });
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Resource", b =>
                {
                    ...
                    b.Property<decimal>("BillableTargetPercent")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("ExemptionStatus")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Availability.ResourceAvailability", b =>
                {
                    b.HasOne("Tracker.Web.Entities.Resource", "ApprovedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Tracker.Web.Entities.Billing.ClientRate", b =>
                {
                    b.HasOne("Tracker.Web.Entities.Resource", "Client")
                        .WithMany()
